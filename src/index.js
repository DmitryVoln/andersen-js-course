...
import { getError } from './asynchronous-programming/task6';
import { foo as foo7 } from './asynchronous-programming/task7';
import { foo as foo8 } from './asynchronous-programming/task8';
import { foo as foo9 } from './asynchronous-programming/task9';
...
console.log(parseJSON('{x}', successCb, failureCb));

//task3
delay(1000).then(v => console.log(`task3========== Done with ${v}`));
...
fetchDataParallel(...urls);
fetchDataConsistently(...urls);
...
foo8('https://kkkjsonplaceholder.typicode.com/users');

//task9
foo9();

//task10
new Musician('https://jsonplaceholder.typicode.com/albums').getAlbums();
